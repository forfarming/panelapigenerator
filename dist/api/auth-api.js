...
exports.AuthApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        apiTokenPost: function (credentialsModel, options) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            localVarRequestOptions.data = common_1.serializeDataIfNeeded(credentialsModel, localVarRequestOptions, configuration);
                            return [2 /*return*/, {
    ...
    return {
        ...
        apiTokenPost: function (credentialsModel, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.apiTokenPost(credentialsModel, options)];
                        case 1:
...
exports.AuthApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         */
        apiTokenPost: function (credentialsModel, options) {
            return localVarFp.apiTokenPost(credentialsModel, options).then(function (request) { return request(axios, basePath); });
        }
    };
};
/**
...
var AuthApi = /** @class */ (function (_super) {
     ...
     * @memberof AuthApi
     */
    AuthApi.prototype.apiTokenPost = function (credentialsModel, options) {
        var _this = this;
        return exports.AuthApiFp(this.configuration).apiTokenPost(credentialsModel, options).then(function (request) { return request(_this.axios, _this.basePath); });
    };
    return AuthApi;
}(base_1.BaseAPI));
